...
def decompose(source_logic: str) -> str:
    """
    ...
    system_instruction = (
        ...
        "Your sole task is to ingest a complex source logic and strip away EVERY trace of its specific domain context, "
    ...
    prompt = f"Decompose the following source logic:\n\n{source_logic}"
