...
class EntityMapping(BaseModel):
    ...
    metaphorical_entity: str = Field(description="The equivalent entity mapped perfectly into the new target domain")
...
def map_isomorphism(abstract_schema_json: str, target_domain: str) -> str:
    """
    Agent 2: The Mapping Agent.
    Takes the abstract relational logic and projects it perfectly onto a new target domain.
    """
    client = get_client()
    ...
    system_instruction = (
        ...
        "You will receive an abstract logical schema (Entities, Relationships, Rules) and a Target Domain. "
    ...
    prompt = (
        ...
        f"Target Domain Context: {target_domain}\n\n"
