...
class TutorSession:
    ...
    Once a operational output is generated, this class is instantiated to hold the 
    ...
    """
    def __init__(self, source_logic: str, target_domain: str, 
    ...
    def get_raw_state(self) -> dict:
        ...
        return {
            "source": self.source_logic,
            "metaphor": self.target_domain,
